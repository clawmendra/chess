...
public class WebSocketHandler {
    ...
    private void handleGameStateNotif(ChessGame game, int gameID) {
        if (game.isInCheckmate(ChessGame.TeamColor.WHITE)) {
